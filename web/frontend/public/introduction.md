...
$$\frac{2 \times 10^{6}}{1.07^{65+30}}+\frac{2 \times 10^{6}}{1.07^{65+60}}+\frac{2 \times 10^{6}}{1.07^{65+90}} \cdots = \sum_{n=0}^{\infty} \frac{I_f}{(1+R)^{Y_r+Y_c n}}$$
...
And let $r = \frac{k}{(1 + R)^{Y_c}}$, then we get the geometrical series:
