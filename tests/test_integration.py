...
class TestFullWorkflow:
        ...
        high_roi_config = OmegaConf.create(
            {
                ...
                "analysis": {"max_generations": 5, "children_per_generation": 3.0},
                "scenarios": {
        ...
        low_roi_config = OmegaConf.create(
            {
                ...
                "analysis": {"max_generations": 10, "children_per_generation": 4.0},
                "scenarios": {
    ...
    def test_fractional_children_workflow(self):
        ...
        for children in config.scenarios.children_options:
            ...
            expected_ratio = children / (
                (1 + config.financial.roi_rate) ** config.financial.generation_gap
            )
    ...
    def test_mathematical_consistency(self):
        ...
        total_dynasty, breakdown = calculator.calculate_dynasty_investment(
        ...
        expected_first_generation = (
            single_child * children
        )  # Generation 0 has k children
    ...
    def test_boundary_conditions(self):
        ...
        max_children = calculator.calculate_max_children_for_convergence(
            config.financial.roi_rate
        )
        ...
        extreme_config = OmegaConf.create(
            {
                ...
                "output": {"verbose": False, "currency": "TEST", "decimal_places": 0},
            }
        )
